            ...
            <div className="details">
                <div className="recentAnalysis">
                  <div className="cardHeader">
                      ...
                      <a href="#" className="actionButton btn-main">استعراض الكل </a>
                  </div>
                  <table className="mainTable">
                      ...
                      <tbody>
                        <tr>
                            ...
                            <td>02-04-2022  </td>
                            <td>03-04-2020</td>
                            <td> <span className="status done">تمت المعالجة </span></td>
                            <td> <a href="#" className="downlode"> <ion-icon name="laptop-outline"></ion-icon></a> </td>
                            <td> <a href="#" className="downlode"> <ion-icon name="arrow-down-circle"></ion-icon></a> </td>
                        </tr>
                        <tr>
                            <td>2</td>
                            <td>04-04-2022  </td>
                            <td>05-04-2020 </td>
                            <td> <span className="status progress">جاري المعالجة</span></td>
                            <td> <a href="#" className="downlode"> <ion-icon name="laptop-outline"></ion-icon></a> </td>
                            <td> <a href="#" className="downlode"> <ion-icon name="arrow-down-circle"></ion-icon></a> </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>06-04-2022</td>
                            <td>07-04-2020 </td>
                            <td> <span className="status   notstart">لم يتم البدء </span></td>
                            <td> <a href="#" className="downlode"> <ion-icon name="laptop-outline"></ion-icon></a> </td>
                            <td> <a href="#" className="downlode"> <ion-icon name="arrow-down-circle"></ion-icon></a> </td>
                        </tr>
